    ...
    <>
      ...
      <Section className="bg-neutral-50">
        <div className="grid md:grid-cols-2 gap-lg mb-xl">
          <Card>
            <h2 className="text-2xl font-bold text-neutral-900 mb-md">What I Do</h2>
            <ul className="space-y-sm text-neutral-700">
          ...
          <Card>
            <h2 className="text-2xl font-bold text-neutral-900 mb-md">My Approach</h2>
            <ul className="space-y-sm text-neutral-700">
